...
export class Backend implements backendInterface {
    ...
    async blockSeat(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.blockSeat(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createRegistration(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getOwnRegistrations(): Promise<Array<StudentRegistration>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOwnRegistrations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRegistrations(): Promise<Array<StudentRegistration>> {
        if (this.processError) {
            try {
    ...
    async getSeatStates(): Promise<Array<Seat>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSeatStates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTodaysRegistrations(): Promise<Array<StudentRegistration>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTodaysRegistrations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async unblockSeat(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unblockSeat(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
