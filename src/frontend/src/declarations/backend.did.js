...
export const idlService = IDL.Service({
  ...
  'getOwnRegistrations' : IDL.Func(
      [],
      [IDL.Vec(StudentRegistration)],
      ['query'],
    ),
  'getRegistrations' : IDL.Func([], [IDL.Vec(StudentRegistration)], ['query']),
  'getSeatStates' : IDL.Func([], [IDL.Vec(Seat)], ['query']),
  'getTodaysRegistrations' : IDL.Func(
      [],
      [IDL.Vec(StudentRegistration)],
      ['query'],
    ),
...
export const idlFactory = ({ IDL }) => {
  ...
  const Seat = IDL.Record({ 'isBlocked' : IDL.Bool, 'seatNumber' : IDL.Nat });
